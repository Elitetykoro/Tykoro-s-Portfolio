...
import { Computer, walls, Arcade, TrashCan, Project1, Project2, Project3 } from "../../levels/overworld.js";
...
export class Player extends GameObject {
  constructor(x, y) {
    ...
    this.interactWithTrashCan = false;
    this.interactWithProject1 = false;
    this.interactWithProject2 = false;
    this.interactWithProject3 = false;
    ...
    if (this.canMove) {
      if (!input.direction) {
        if (this.facingDirection === DOWN) {
          this.body.animation = STAND_DOWN;
        }
        if (this.facingDirection === UP) {
          this.body.animation = STAND_UP;
        }
        if (this.facingDirection === LEFT) {
          this.body.animation = STAND_LEFT;
        }
        if (this.facingDirection === RIGHT) {
          this.body.animation = STAND_RIGHT;
        }
        return;
      }
      ...
      this.interactingWith = [
        ...
        (this.interactWithTrashCan = !isSpaceFree(TrashCan, nextX, nextY)),
        (this.interactWithArcade = !isSpaceFree(Arcade, nextX, nextY)),
        (this.interactWithProject1 = !isSpaceFree(Project1, nextX, nextY)),
        (this.interactWithProject2 = !isSpaceFree(Project2, nextX, nextY)),
        (this.interactWithProject3 = !isSpaceFree(Project3, nextX, nextY)),
      ];
